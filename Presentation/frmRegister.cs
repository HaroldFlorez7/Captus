...
namespace Presentation
{
    public partial class frmRegister : Form
    {
        ...
        //public bool SendVerifyCode(string destino, string codigo)
        //{
        //    var mensaje = new MailMessage("captusupc07@gmail.com", destino);
        //    mensaje.Subject = "Código de verificación";
        //    mensaje.Body = $"Tu código de verificación es: {codigo}";

        //    var smtp = new SmtpClient("smtp.gmail.com", 587)
        //    {
        //        Credentials = new NetworkCredential("captusupc07@gmail.com", "tuAppPassword"),
        //        EnableSsl = true
        //    };
        //    smtp.Send(mensaje);
        //    string codigoUsuario = Microsoft.VisualBasic.VBCodeProvider("Ingrese el código de verificación enviado a su correo:", "Verificar código", "");
